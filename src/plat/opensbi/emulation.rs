...
pub const SBI_EXT_TIME: u64 = 0x8;
pub const SBI_EXT_IPI: u64 = 0x8;
pub const SBI_EXT_RFENCE: u64 = 0x8;
pub const SBI_EXT_HSM: u64 = 0x8;
pub const SBI_EXT_SRST: u64 = 0x8;

pub struct SbiArg {
    pub ext_id: u64, // EID - a7
    pub func_id: u64, // FID - a6
    pub arg: [u64; 6], // args - a0~a5
    pub ret_val: [u64; 2], // return - a0, a1
}
